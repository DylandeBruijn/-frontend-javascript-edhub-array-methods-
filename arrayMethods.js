...
const filteredSixteenthCenturyInventors = inventors.filter((inventor) => {
  return inventor.year >= 1501 && inventor.year <= 1600;
})

console.log(filteredSixteenthCenturyInventors);
...
const birthYearInventors = inventors.map((inventor) => {
   return inventor.year;
});

console.log(birthYearInventors);
...
const birthYearInventorsSorted = inventors.sort((a, b) => {
  return a.year - b.year;
});

console.log(birthYearInventorsSorted);
...
const thomasEdison = inventors.find((inventor) => {
  return inventor.last === 'Edison';
});

console.log(thomasEdison);